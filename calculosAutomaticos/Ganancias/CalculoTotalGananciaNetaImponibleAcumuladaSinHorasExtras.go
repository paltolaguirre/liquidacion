...
func (cg *CalculoTotalGananciaNetaImponibleAcumuladaSinHorasExtras) getResult() float64 {
	...
	return cg.getResultOnDemandTemplate("Total Ganancia Neta Imponible Acumulada Sin Horas Extras", "TOTAL_GANANCIA_NETA_IMPONIBLE_ACUMULADA_SIN_HORAS_EXTRAS", 49, cg)
}
